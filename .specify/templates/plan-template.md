...
**Performance Goals**: [domain-specific, e.g., <500ms API response, 10k concurrent users, or NEEDS CLARIFICATION]
**Constraints**: [domain-specific, e.g., DDD patterns, React best practices, or NEEDS CLARIFICATION]
**Scale/Scope**: [domain-specific, e.g., 50k products, 10k users, or NEEDS CLARIFICATION]
